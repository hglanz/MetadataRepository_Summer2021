...
for(i in 1:15391) {
  ...
  for(j in links) {
    #tryCatch(expr = {
    #  full_df <- rbind(full_df, scrape_datagov(j))
    #}, error = function(err) {
    #  NULL
    #})
    full_df
...
full_df
scrape_datagov("https://catalog.data.gov/dataset/low-altitude-aerial-imagery-obtained-with-unmanned-aerial-systems-uas-flights-over-black-beach")
```
