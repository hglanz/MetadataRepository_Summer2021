...
```{r}
url <- "https://dataverse.harvard.edu/dataverse/TrumpTweets2020;jsessionid=639f9c1b20298462c57f46db93ef"
...
for(i in 1:11395) {
  ...
  pg <- read_html(url)
  links <- html_attr(html_nodes(pg, ".card-title-icon-block a"), "href")
